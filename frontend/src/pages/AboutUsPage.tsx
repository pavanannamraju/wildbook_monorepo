    ...
    <main className="mx-auto w-full max-w-[1920px] bg-[#F6F4F0]">
      <section className="relative h-[600px] overflow-hidden">
        ...
        <div className="absolute left-1/2 top-1/2 z-10 w-full max-w-[1600px] -translate-x-1/2 -translate-y-1/2 page-px">
          <h1 className="max-w-[580px] font-['Cocogoose_Pro'] text-[32px] leading-tight text-[#E8E2DC] drop-shadow-[0_4px_4px_rgba(0,0,0,0.4)] md:text-[44px] lg:text-[52px]">
      ...
      <section className="page-px pb-16 md:pb-20">
        ...
        >
          <div className="mx-auto max-w-[1120px]">
            <p className="text-center text-[16px] font-bold text-(--color-wildbook-accent) md:text-[20px]">
              What we’re working towards
            </p>
            <p className="mt-2 text-center text-[16px] font-bold text-[#2F2B28] md:text-[20px]">
              ...
              {PROGRESS_ITEMS.map((item) => (
                <article key={item.title} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <h2 className="font-['Cocogoose_Pro'] text-[12px] leading-8 text-[#2F2B28] md:text-[16px]">
                      {item.title}
                    </h2>
                  </div>
      ...
      <section className="page-px pb-8 md:pb-12">
        <div className="mx-auto max-w-[1379px]">
          <div className="grid grid-cols-2 items-center gap-x-8 gap-y-6 md:grid-cols-4 md:gap-x-10 md:gap-y-8">
      ...
      <section className="page-px pb-16 md:pb-20">
        <div className="mx-auto flex w-full max-w-[1232px] flex-col items-center gap-8 text-center">
          <div>
