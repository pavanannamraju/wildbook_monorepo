...
export function AboutUs() {
  return (
    <section className="pt-16 lg:pt-20 page-px max-w-[2000px] mx-auto">
      <div
        className="w-full mx-auto bg-[#0B6E66] rounded-2xl overflow-hidden"
        style={{
      ...
      >
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-[80px] xl:gap-[120px] px-[24px] lg:px-[60px] py-[40px] lg:py-[48px]">
          {/* Left column — ~38% of inner content per Figma (575px / 1508px) */}
          ...
          {/* Right column — font-normal (Regular 400) per Figma, leading-[28px] */}
